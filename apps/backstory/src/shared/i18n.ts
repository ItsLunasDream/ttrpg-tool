...
const de = {
  ...
  'bar.importZip': 'Aus ZIP einlesen',
  'export.toc': 'Inhalt',
  'export.graph': 'Beziehungsnetz',
  'export.withGraph': 'Beziehungsnetz als letzte Seite',
  'export.title': 'Kampagne exportieren',
  'export.chooseNotes': 'Welche Notizen?',
  'export.all': 'Alle',
  'export.none': 'Keine',
  'export.withToc': 'Inhaltsverzeichnis auf der ersten Seite',
  'export.selected': '{count} von {total} ausgewählt',
  'export.start': 'Exportieren',
  'error.importUnreadable': 'Die Datei lässt sich nicht als Sicherung lesen.',
  'error.importNoCampaign': 'In der Datei steckt keine Kampagne (campaign.json fehlt).',
  'msg.imported': 'Kampagne „{name}“ eingelesen.',
  'spell.add': '„{word}“ ins Wörterbuch aufnehmen',
  'spell.added': '„{word}“ steht jetzt im Wörterbuch',
  'spell.title': 'Wörterbuch',
  'spell.empty': 'Noch keine eigenen Wörter.',
  'spell.remove': 'Entfernen',
  'editor.collapse': 'Abschnitt einklappen',
  'editor.expand': 'Abschnitt aufklappen',
  'editor.expandAll': 'Alles aufklappen',
  'editor.zoom': '{percent}%',
...
const en: Partial<Record<MessageKey, string>> = {
  ...
  'editor.zoom': '{percent}%',
  'bar.importZip': 'Read from ZIP',
  'export.toc': 'Contents',
  'export.graph': 'Relationship map',
  'export.withGraph': 'Relationship map as the last page',
  'export.title': 'Export campaign',
  'export.chooseNotes': 'Which notes?',
  'export.all': 'All',
  'export.none': 'None',
  'export.withToc': 'Table of contents on the first page',
  'export.selected': '{count} of {total} selected',
  'export.start': 'Export',
  'error.importUnreadable': 'That file cannot be read as a backup.',
  'error.importNoCampaign': 'No campaign in that file (campaign.json is missing).',
  'msg.imported': 'Campaign “{name}” read in.',
  'spell.add': 'Add “{word}” to the dictionary',
  'spell.added': '“{word}” is now in the dictionary',
  'spell.title': 'Dictionary',
  'spell.empty': 'No custom words yet.',
  'spell.remove': 'Remove',
