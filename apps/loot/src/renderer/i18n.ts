...
const TEXTE = {
  ...
  story: ['In den Story Creator', 'To the Story Creator'],
  'story.titel': ['Beute: {name}', 'Loot: {name}'],
  'story.fertig': ['Als Notiz angelegt: {text}', 'Created as a note: {text}'],
  'story.fehler': ['Nicht angelegt: {text}', 'Not created: {text}'],
