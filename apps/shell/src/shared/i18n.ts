...
const en = {
  ...
  'room.showPublic': 'Show public IPv4',
  'room.publicHint': 'Asks api.ipify.org, which sees your IP address.',
...
const de: Partial<Record<MessageKey, string>> = {
  ...
  'room.addrPublic': 'Internet (IPv4)',
  'room.showPublic': 'Öffentliche IPv4 zeigen',
  'room.publicHint': 'Fragt api.ipify.org, das dabei deine IP-Adresse sieht.',
