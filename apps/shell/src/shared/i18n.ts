...
const en = {
  ...
  'room.unencrypted': 'The room is not encrypted: anyone on the same network can read along, private messages included.',
  ...
  'room.address': 'Address:port',
  'room.open': 'Open a room',
  'room.roomName': 'Room name',
  'room.openButton': 'Open room',
  'room.youHost': 'You host. Address: {adresse}',
  ...
  'room.send': 'Send',
  'room.privateHint': 'Only this person sees the message in the app. On the network it is readable.',
...
const de: Partial<Record<MessageKey, string>> = {
  ...
  'room.unencrypted': 'Der Raum ist nicht verschlüsselt: Wer im selben Netz mitliest, sieht alles, auch private Nachrichten.',
  ...
  'room.send': 'Senden',
  'room.privateHint': 'In der App sieht nur diese Person die Nachricht. Im Netz ist sie mitlesbar.',
