 ...
 * aussen vor. Gleiches Vorgehen wie in den anderen Werkzeugen: das fertige
 * Paket braucht dadurch kein node_modules.
 */
const shared = {
  bundle: true,
  platform: 'node',
...
console.log('nachschlagewerk: main + preload gebaut');
