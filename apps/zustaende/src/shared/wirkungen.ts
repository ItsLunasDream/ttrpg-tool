 ...
 *
 * ZUR SKALA: die Punkte laufen von 2 bis 36, und jede Schwere hat ihren
 * eigenen Bereich — leicht 2–5, mittel 6–10, schwer 11–16, toedlich 26–36.
 * Vorher reichte sie nur bis 12, und dann gab es je Schwere ein oder zwei
 * verschiedene Werte. Damit sagte die Zahl nichts, was die Schwere nicht
 * schon sagte: „festgehalten" und „taub" wogen beide gleich viel, und ein
 * Zustand konnte auf Stufe 5 harmloser sein als auf Stufe 4. Eine bloss
 * gestreckte Skala haette daran nichts geaendert — der Gewinn steckt nicht
 * im groesseren Hoechstwert, sondern darin, dass die Werte innerhalb einer
 * Schwere auseinandergezogen sind.
 *
...
const ALLGEMEIN: readonly Wirkung[] = [
  /* ---------- leicht ---------- */
  { id: 'nachteil-wahrnehmung', schwere: 'leicht', spur: 'sinne', richtung: 'debuff', punkte: 4,
    text: { de: 'Nachteil auf Wahrnehmung', en: 'Disadvantage on Perception checks' } },
  { id: 'nachteil-eine-fertigkeit', schwere: 'leicht', spur: 'geist', richtung: 'debuff', punkte: 3,
    text: { de: 'Nachteil auf eine Fertigkeit deiner Wahl', en: 'Disadvantage on one skill of your choice' } },
  { id: 'bewegung-minus-fuenf', schwere: 'leicht', spur: 'bewegung', richtung: 'debuff', punkte: 3,
    text: { de: 'Bewegungsrate um 5 Fuß gesenkt', en: 'Speed reduced by 5 feet' } },
  { id: 'lautlos-unmoeglich', schwere: 'leicht', spur: 'sinne', richtung: 'debuff', punkte: 2,
    text: { de: 'Du kannst dich nicht heimlich bewegen', en: 'You cannot move stealthily' } },
  { id: 'minus-eins-rettung', schwere: 'leicht', spur: 'verteidigung', richtung: 'debuff', punkte: 4,
    text: { de: '−1 auf Rettungswürfe', en: '−1 to saving throws' } },
  { id: 'nachteil-konzentration', schwere: 'leicht', spur: 'geist', richtung: 'debuff', punkte: 4,
    text: { de: 'Nachteil auf Würfe, um Konzentration zu halten', en: 'Disadvantage on checks to maintain concentration' } },
  { id: 'kein-langer-blick', schwere: 'leicht', spur: 'sinne', richtung: 'debuff', punkte: 3,
    text: { de: 'Du siehst weiter als 30 Fuß nur verschwommen', en: 'Everything beyond 30 feet is blurred' } },
  { id: 'unruhiger-schlaf', schwere: 'leicht', spur: 'koerper', richtung: 'debuff', punkte: 5,
    text: { de: 'Eine Rast erholt dich nur halb', en: 'A rest restores only half as much' } },
  { id: 'minus-zwei-initiative', schwere: 'leicht', spur: 'handlung', richtung: 'debuff', punkte: 2,
    text: { de: '−2 auf Initiative', en: '−2 to initiative' } },
  { id: 'schaden-eins-weniger', schwere: 'leicht', spur: 'angriff', richtung: 'debuff', punkte: 2,
    text: { de: 'Deine Angriffe richten 1W4 Schaden weniger an (mindestens 1)', en: 'Your attacks deal 1d4 less damage (minimum 1)' } },

  /* ---------- mittel ---------- */
  { id: 'bewegung-halbiert', schwere: 'mittel', spur: 'bewegung', richtung: 'debuff', punkte: 7,
    text: { de: 'Bewegungsrate halbiert', en: 'Speed halved' } },
  { id: 'nachteil-rettungen', schwere: 'mittel', spur: 'verteidigung', richtung: 'debuff', punkte: 8,
    text: { de: 'Nachteil auf Rettungswürfe', en: 'Disadvantage on saving throws' } },
  { id: 'keine-reaktion', schwere: 'mittel', spur: 'handlung', richtung: 'debuff', punkte: 8,
    text: { de: 'Du kannst keine Reaktion nutzen', en: 'You cannot take reactions' } },
  { id: 'nachteil-geschick', schwere: 'mittel', spur: 'koerper', richtung: 'debuff', punkte: 6,
    text: { de: 'Nachteil auf Geschicklichkeitsproben', en: 'Disadvantage on Dexterity checks' } },
  { id: 'nachteil-staerke', schwere: 'mittel', spur: 'koerper', richtung: 'debuff', punkte: 6,
    text: { de: 'Nachteil auf Stärkeproben', en: 'Disadvantage on Strength checks' } },
  { id: 'kein-vorteil', schwere: 'mittel', spur: 'angriff', richtung: 'debuff', punkte: 6,
    text: { de: 'Du kannst keinen Vorteil auf Angriffe erhalten', en: 'You cannot gain advantage on attacks' } },
  { id: 'minus-zwei-angriffe', schwere: 'mittel', spur: 'angriff', richtung: 'debuff', punkte: 7,
    text: { de: '−2 auf Angriffswürfe', en: '−2 to attack rolls' } },
  { id: 'hoechst-tp-gesenkt', schwere: 'mittel', spur: 'koerper', richtung: 'debuff', punkte: 10,
    text: { de: 'Deine Trefferpunkte-Höchstgrenze sinkt um 1W10', en: 'Your hit point maximum drops by 1d10' } },
  { id: 'angriffe-gegen-dich-vorteil', schwere: 'mittel', spur: 'verteidigung', richtung: 'debuff', punkte: 9,
    text: { de: 'Angriffe gegen dich haben Vorteil', en: 'Attacks against you have advantage' } },
  { id: 'keine-heilung', schwere: 'mittel', spur: 'koerper', richtung: 'debuff', punkte: 9,
    text: { de: 'Heilung wirkt bei dir nur halb', en: 'Healing restores only half as much to you' } },

  /* ---------- schwer ---------- */
  { id: 'nachteil-angriffe', schwere: 'schwer', spur: 'angriff', richtung: 'debuff', punkte: 12,
    text: { de: 'Nachteil auf alle Angriffswürfe', en: 'Disadvantage on all attack rolls' } },
  { id: 'keine-bonusaktion', schwere: 'schwer', spur: 'handlung', richtung: 'debuff', punkte: 11,
    text: { de: 'Du kannst keine Bonusaktion nutzen', en: 'You cannot take bonus actions' } },
  { id: 'blind', schwere: 'schwer', spur: 'sinne', richtung: 'debuff', punkte: 14,
    text: { de: 'Du bist blind', en: 'You are blinded' } },
  { id: 'taub', schwere: 'schwer', spur: 'sinne', richtung: 'debuff', punkte: 11,
    text: { de: 'Du bist taub', en: 'You are deafened' } },
  { id: 'festgehalten', schwere: 'schwer', spur: 'bewegung', richtung: 'debuff', punkte: 15,
    text: { de: 'Du bist festgehalten', en: 'You are restrained' } },
  { id: 'keine-zauber', schwere: 'schwer', spur: 'geist', richtung: 'debuff', punkte: 14,
    text: { de: 'Du kannst nicht zaubern', en: 'You cannot cast spells' } },
  { id: 'verwirrt', schwere: 'schwer', spur: 'geist', richtung: 'debuff', punkte: 14,
  ...
  { id: 'erschoepfung', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 13,
   ...
   */
  { id: 'handlungsunfaehig', schwere: 'toedlich', spur: 'handlung', richtung: 'debuff', punkte: 30,
    text: { de: 'Du bist handlungsunfähig', en: 'You are incapacitated' } },
  { id: 'gelaehmt', schwere: 'toedlich', spur: 'handlung', richtung: 'debuff', punkte: 26,
    text: { de: 'Du bist gelähmt', en: 'You are paralysed' } },
  { id: 'bewusstlos', schwere: 'toedlich', spur: 'handlung', richtung: 'debuff', punkte: 33,
    text: { de: 'Du bist bewusstlos', en: 'You are unconscious' } },
  { id: 'sterbend', schwere: 'toedlich', spur: 'koerper', richtung: 'debuff', punkte: 33,
    text: { de: 'Du fällst auf 0 Trefferpunkte', en: 'You drop to 0 hit points' } },
  { id: 'tod-nach-frist', schwere: 'toedlich', spur: 'koerper', richtung: 'debuff', punkte: 36,
   ...
   */
  { id: 'schaden-klein', schwere: 'leicht', spur: 'schaden', richtung: 'schaden', punkte: 3,
    text: { de: '1W4 Schaden je Frist', en: '1d4 damage each interval' } },
  { id: 'schaden-mittel', schwere: 'mittel', spur: 'schaden', richtung: 'schaden', punkte: 7,
    text: { de: '2W6 Schaden je Frist', en: '2d6 damage each interval' } },
  { id: 'schaden-gross', schwere: 'schwer', spur: 'schaden', richtung: 'schaden', punkte: 13,
    text: { de: '4W6 Schaden je Frist', en: '4d6 damage each interval' } },

  /* ---------- Buffs: die Gegenrichtung ---------- */
  { id: 'vorteil-eine-sache', schwere: 'leicht', spur: 'geist', richtung: 'buff', punkte: -3,
    text: { de: 'Vorteil auf eine Sache deiner Wahl', en: 'Advantage on one thing of your choice' } },
  { id: 'bewegung-plus-zehn', schwere: 'leicht', spur: 'bewegung', richtung: 'buff', punkte: -3,
    text: { de: 'Bewegungsrate um 10 Fuß erhöht', en: 'Speed increased by 10 feet' } },
  { id: 'zeitweilige-tp', schwere: 'leicht', spur: 'koerper', richtung: 'buff', punkte: -4,
    text: { de: '2W6 zeitweilige Trefferpunkte', en: '2d6 temporary hit points' } },
  /*
   * Sieben leichte Buffs, nicht drei.
   *
   * Ein Segen auf „laestig" mit fuenf Stufen fand nach der dritten Stufe
   * keinen leichten Buff mehr und stieg nach „mittel" auf — der Regler war
   * damit ausgehebelt. Das war kein Fehler im Erzeuger, sondern eine Luecke
   * in der Liste: Segen hatten von Anfang an weniger Bausteine als Fluesche.
   */
  { id: 'plus-zwei-initiative', schwere: 'leicht', spur: 'handlung', richtung: 'buff', punkte: -2,
    text: { de: '+2 auf Initiative', en: '+2 to initiative' } },
  { id: 'gelaendegaengig', schwere: 'leicht', spur: 'bewegung', richtung: 'buff', punkte: -2,
    text: { de: 'Schwieriges Gelände kostet dich keine zusätzliche Bewegung', en: 'Difficult terrain costs you no extra movement' } },
  { id: 'plus-eins-ruestung', schwere: 'leicht', spur: 'verteidigung', richtung: 'buff', punkte: -3,
    text: { de: '+1 auf Rüstungsklasse', en: '+1 to Armour Class' } },
  { id: 'dunkelsicht', schwere: 'leicht', spur: 'sinne', richtung: 'buff', punkte: -3,
    text: { de: 'Du siehst 60 Fuß weit auch im Dunkeln', en: 'You see 60 feet even in darkness' } },
  { id: 'widerstand-eine-art', schwere: 'mittel', spur: 'verteidigung', richtung: 'buff', punkte: -7,
    text: { de: 'Resistenz gegen eine Schadensart', en: 'Resistance to one damage type' } },
  { id: 'plus-eins-angriffe', schwere: 'mittel', spur: 'angriff', richtung: 'buff', punkte: -6,
    text: { de: '+1 auf Angriffswürfe', en: '+1 to attack rolls' } },
  { id: 'schaden-dazu', schwere: 'mittel', spur: 'angriff', richtung: 'buff', punkte: -6,
    text: { de: 'Deine Angriffe richten 1W6 Schaden mehr an', en: 'Your attacks deal 1d6 extra damage' } },
  { id: 'zweite-rettung', schwere: 'mittel', spur: 'verteidigung', richtung: 'buff', punkte: -8,
    text: { de: 'Einmal je Frist darfst du einen Rettungswurf wiederholen', en: 'Once each interval you may reroll one saving throw' } },
  { id: 'schnelle-heilung', schwere: 'mittel', spur: 'koerper', richtung: 'buff', punkte: -9,
    text: { de: 'Zu Beginn deines Zuges heilst du 1W6 Trefferpunkte', en: 'At the start of your turn you regain 1d6 hit points' } },
  { id: 'kurz-unsichtbar', schwere: 'schwer', spur: 'sinne', richtung: 'buff', punkte: -12,
    text: { de: 'Du bist unsichtbar, bis du angreifst oder zauberst', en: 'You are invisible until you attack or cast a spell' } },
  { id: 'vorteil-rettungen', schwere: 'schwer', spur: 'verteidigung', richtung: 'buff', punkte: -11,
    text: { de: 'Vorteil auf Rettungswürfe', en: 'Advantage on saving throws' } },
  { id: 'zusatzangriff', schwere: 'schwer', spur: 'angriff', richtung: 'buff', punkte: -13,
    text: { de: 'Ein zusätzlicher Angriff, wenn du angreifst', en: 'One extra attack when you take the Attack action' } },
  { id: 'nicht-unter-null', schwere: 'toedlich', spur: 'koerper', richtung: 'buff', punkte: -28,
    text: { de: 'Du fällst nicht unter 1 Trefferpunkt', en: 'You do not drop below 1 hit point' } },
  { id: 'zurueck-auf-die-beine', schwere: 'toedlich', spur: 'koerper', richtung: 'buff', punkte: -30,
    text: { de: 'Fällst du auf 0 Trefferpunkte, stehst du am Ende deines nächsten Zuges mit der Hälfte wieder auf', en: 'If you drop to 0 hit points, you rise at the end of your next turn with half of them' } }
];
...
const THEMENEIGEN: readonly Wirkung[] = [
  /* ---------- Kälte ---------- */
  { id: 'kaelte-klamm', schwere: 'leicht', spur: 'koerper', richtung: 'debuff', punkte: 3, themen: ['kaelte'],
    text: { de: 'Klamme Finger: −2 auf Geschicklichkeitsproben', en: 'Numb fingers: −2 to Dexterity checks' } },
  { id: 'kaelte-steife-glieder', schwere: 'leicht', spur: 'bewegung', richtung: 'debuff', punkte: 4, themen: ['kaelte'],
    text: { de: 'Steife Glieder: Bewegungsrate um 10 Fuß gesenkt', en: 'Stiff limbs: speed reduced by 10 feet' } },
  { id: 'kaelte-zittern', schwere: 'mittel', spur: 'koerper', richtung: 'debuff', punkte: 7, themen: ['kaelte'],
  ...
  { id: 'kaelte-frostschaden', schwere: 'mittel', spur: 'schaden', richtung: 'schaden', punkte: 6, themen: ['kaelte'],
  ...
  { id: 'kaelte-festgefroren', schwere: 'schwer', spur: 'bewegung', richtung: 'debuff', punkte: 15, themen: ['kaelte'],
  ...
  { id: 'kaelte-blaue-haut', schwere: 'schwer', spur: 'verteidigung', richtung: 'debuff', punkte: 14, themen: ['kaelte'],
    text: { de: 'Blaue Haut: Kälteschaden an dir ist verdoppelt, und Wärme tut weh', en: 'Blue skin: cold damage against you is doubled, and warmth hurts' } },
  { id: 'kaelte-erstarrt', schwere: 'toedlich', spur: 'handlung', richtung: 'debuff', punkte: 30, themen: ['kaelte'],
    text: { de: 'Vollständig erstarrt: Du bist gelähmt, bis dich jemand eine Stunde lang wärmt', en: 'Frozen solid: you are paralysed until someone warms you for an hour' } },

  /* ---------- Hitze ---------- */
  { id: 'hitze-durst', schwere: 'leicht', spur: 'koerper', richtung: 'debuff', punkte: 3, themen: ['hitze'],
  ...
  { id: 'hitze-ruestung-glueht', schwere: 'mittel', spur: 'verteidigung', richtung: 'debuff', punkte: 7, themen: ['hitze', 'feuer'],
  ...
  { id: 'hitze-flimmern', schwere: 'mittel', spur: 'sinne', richtung: 'debuff', punkte: 6, themen: ['hitze', 'licht'],
    text: { de: 'Die Luft flimmert: −5 auf Angriffe über 30 Fuß Entfernung', en: 'The air shimmers: −5 to attacks beyond 30 feet' } },
  { id: 'hitze-hitzschlag', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 13, themen: ['hitze'],
  ...
  { id: 'hitze-fieberwahn', schwere: 'schwer', spur: 'geist', richtung: 'debuff', punkte: 12, themen: ['hitze'],
    text: { de: 'Fieberwahn: Nachteil auf Intelligenz-, Weisheits- und Charismaproben', en: 'Feverish: disadvantage on Intelligence, Wisdom and Charisma checks' } },

  /* ---------- Fäulnis ---------- */
  { id: 'faeulnis-gestank', schwere: 'leicht', spur: 'koerper', richtung: 'debuff', punkte: 2, themen: ['faeulnis'],
    text: { de: 'Der Gestank hängt an dir: Nachteil auf Charismaproben', en: 'The stench clings to you: disadvantage on Charisma checks' } },
  { id: 'faeulnis-nekrotisch', schwere: 'mittel', spur: 'schaden', richtung: 'schaden', punkte: 6, themen: ['faeulnis', 'schatten'],
    text: { de: '1W6 nekrotischer Schaden je Frist', en: '1d6 necrotic damage each interval' } },
  { id: 'faeulnis-fleisch', schwere: 'mittel', spur: 'koerper', richtung: 'debuff', punkte: 10, themen: ['faeulnis'],
  ...
  { id: 'faeulnis-keine-heilung', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 14, themen: ['faeulnis'],
  ...
  { id: 'faeulnis-taube-hand', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 12, themen: ['faeulnis'],
    text: { de: 'Eine Hand ist gefühllos: Du kannst nichts Zweihändiges führen', en: 'One hand is numb: you cannot wield anything two-handed' } },

  /* ---------- Wahnsinn ---------- */
  { id: 'wahnsinn-stimmen', schwere: 'leicht', spur: 'geist', richtung: 'debuff', punkte: 3, themen: ['wahnsinn', 'traum'],
  ...
  { id: 'wahnsinn-misstrauen', schwere: 'mittel', spur: 'geist', richtung: 'debuff', punkte: 6, themen: ['wahnsinn'],
  ...
  { id: 'wahnsinn-wurf', schwere: 'schwer', spur: 'handlung', richtung: 'debuff', punkte: 14, themen: ['wahnsinn'],
  ...
  { id: 'wahnsinn-fremde-gesichter', schwere: 'schwer', spur: 'sinne', richtung: 'debuff', punkte: 12, themen: ['wahnsinn'],
    text: { de: 'Jedes Gesicht ist fremd: Du kannst Verbündete nicht sicher von Gegnern unterscheiden', en: 'Every face is a stranger: you cannot reliably tell allies from enemies' } },
  { id: 'wahnsinn-vergessen', schwere: 'schwer', spur: 'geist', richtung: 'debuff', punkte: 13, themen: ['wahnsinn', 'leere'],
  ...
  /* ---------- Licht ---------- */
  { id: 'licht-nachbild', schwere: 'leicht', spur: 'sinne', richtung: 'debuff', punkte: 4, themen: ['licht'],
    text: { de: 'Nachbilder im Blick: −2 auf Angriffswürfe', en: 'Afterimages: −2 to attack rolls' } },
  { id: 'licht-leuchtend', schwere: 'mittel', spur: 'verteidigung', richtung: 'debuff', punkte: 8, themen: ['licht'],
  ...
  { id: 'licht-strahlend', schwere: 'mittel', spur: 'schaden', richtung: 'schaden', punkte: 7, themen: ['licht'],
  ...
  { id: 'licht-geblendet', schwere: 'schwer', spur: 'sinne', richtung: 'debuff', punkte: 13, themen: ['licht'],
  ...
  { id: 'licht-ausgebrannt', schwere: 'schwer', spur: 'geist', richtung: 'debuff', punkte: 12, themen: ['licht'],
    text: { de: 'Ausgebrannte Augen: Du kannst nicht lesen, auch keine Schriftrollen', en: 'Burnt-out eyes: you cannot read, not even scrolls' } },

  /* ---------- Leere ---------- */
  { id: 'leere-taub-im-kopf', schwere: 'leicht', spur: 'geist', richtung: 'debuff', punkte: 3, themen: ['leere'],
    text: { de: '−2 auf Intelligenz- und Weisheitsproben', en: '−2 to Intelligence and Wisdom checks' } },
  { id: 'leere-starren', schwere: 'mittel', spur: 'handlung', richtung: 'debuff', punkte: 10, themen: ['leere'],
  ...
  { id: 'leere-auszehrung', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 13, themen: ['leere', 'tiefe'],
  ...
  { id: 'leere-ohne-namen', schwere: 'schwer', spur: 'geist', richtung: 'debuff', punkte: 12, themen: ['leere'],
    text: { de: 'Du vergisst deinen Namen: Nachteil auf alle Charismaproben und -rettungswürfe', en: 'You forget your name: disadvantage on all Charisma checks and saves' } },
  { id: 'leere-ausgeloescht', schwere: 'toedlich', spur: 'geist', richtung: 'debuff', punkte: 30, themen: ['leere'],
    text: { de: 'Von dir bleibt nichts: Du bist bewusstlos und träumst nicht; nur Magie holt dich zurück', en: 'Nothing of you remains: you are unconscious and do not dream; only magic brings you back' } },

  /* ---------- Feuer ---------- */
  { id: 'feuer-brennt', schwere: 'leicht', spur: 'schaden', richtung: 'schaden', punkte: 3, themen: ['feuer'],
  ...
  { id: 'feuer-versengte-haut', schwere: 'leicht', spur: 'verteidigung', richtung: 'debuff', punkte: 3, themen: ['feuer'],
  ...
  { id: 'feuer-frisst-sich-fest', schwere: 'mittel', spur: 'schaden', richtung: 'schaden', punkte: 8, themen: ['feuer'],
  ...
  { id: 'feuer-verbrannte-haende', schwere: 'mittel', spur: 'angriff', richtung: 'debuff', punkte: 6, themen: ['feuer', 'saeure'],
  ...
  { id: 'feuer-lodernd', schwere: 'schwer', spur: 'schaden', richtung: 'schaden', punkte: 14, themen: ['feuer'],
  ...
  { id: 'feuer-verwundbar', schwere: 'schwer', spur: 'verteidigung', richtung: 'debuff', punkte: 13, themen: ['feuer'],
  ...
  { id: 'feuer-brandwunden', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 14, themen: ['feuer'],
    text: { de: 'Brandwunden: Trefferpunkte-Höchstgrenze um 2W10 gesenkt, bis sie versorgt sind', en: 'Burns: hit point maximum reduced by 2d10 until they are treated' } },
  { id: 'feuer-verzehrt', schwere: 'toedlich', spur: 'koerper', richtung: 'debuff', punkte: 33, themen: ['feuer'],
    text: { de: 'Die Flammen verzehren dich: 6W6 Feuerschaden je Frist, und Heilung wirkt nicht', en: 'The flames consume you: 6d6 fire damage each interval, and healing does not work' } },

  /* ---------- Gift ---------- */
  { id: 'gift-uebelkeit', schwere: 'leicht', spur: 'koerper', richtung: 'debuff', punkte: 3, themen: ['gift'],
    text: { de: 'Übelkeit: Nachteil auf Konstitutionsproben', en: 'Nausea: disadvantage on Constitution checks' } },
  { id: 'gift-schaden', schwere: 'mittel', spur: 'schaden', richtung: 'schaden', punkte: 7, themen: ['gift'],
  ...
  { id: 'gift-kriecht-weiter', schwere: 'mittel', spur: 'koerper', richtung: 'debuff', punkte: 10, themen: ['gift', 'blut'],
  ...
  { id: 'gift-laehmend', schwere: 'schwer', spur: 'handlung', richtung: 'debuff', punkte: 14, themen: ['gift'],
  ...
  { id: 'gift-schwaeche', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 13, themen: ['gift'],
    text: { de: 'Das Gift zehrt: Nachteil auf Stärke- und Konstitutionsrettungswürfe, und du trägst nur die Hälfte', en: 'The venom saps you: disadvantage on Strength and Constitution saves, and you carry only half as much' } },
  { id: 'gift-herzstillstand', schwere: 'toedlich', spur: 'koerper', richtung: 'debuff', punkte: 33, themen: ['gift'],
    text: { de: 'Das Gift erreicht das Herz: Du fällst auf 0 Trefferpunkte und hast Nachteil auf Todesrettungswürfe', en: 'The venom reaches your heart: you drop to 0 hit points and have disadvantage on death saves' } },

  /* ---------- Säure ---------- */
  { id: 'saeure-ruestung-an', schwere: 'leicht', spur: 'verteidigung', richtung: 'debuff', punkte: 4, themen: ['saeure'],
    text: { de: 'Die Säure frisst deine Rüstung: −1 auf Rüstungsklasse', en: 'The acid eats at your armour: −1 to Armour Class' } },
  { id: 'saeure-schaden', schwere: 'mittel', spur: 'schaden', richtung: 'schaden', punkte: 6, themen: ['saeure'],
  ...
  { id: 'saeure-riemen', schwere: 'mittel', spur: 'verteidigung', richtung: 'debuff', punkte: 6, themen: ['saeure'],
  ...
  { id: 'saeure-ruestung-zerfressen', schwere: 'schwer', spur: 'verteidigung', richtung: 'debuff', punkte: 12, themen: ['saeure'],
  ...
  { id: 'saeure-veraetzte-haende', schwere: 'schwer', spur: 'handlung', richtung: 'debuff', punkte: 12, themen: ['saeure'],
  ...
  { id: 'saeure-blinde-augen', schwere: 'schwer', spur: 'sinne', richtung: 'debuff', punkte: 14, themen: ['saeure'],
    text: { de: 'Säure in den Augen: Du bist blind, bis dich jemand mit einer Aktion auswäscht', en: 'Acid in your eyes: you are blinded until someone washes them out with an action' } },

  /* ---------- Sturm ---------- */
  { id: 'sturm-laerm', schwere: 'leicht', spur: 'sinne', richtung: 'debuff', punkte: 3, themen: ['sturm'],
  ...
  { id: 'sturm-gegenwind', schwere: 'mittel', spur: 'bewegung', richtung: 'debuff', punkte: 7, themen: ['sturm'],
    text: { de: 'Gegenwind: Jeder Fuß Bewegung kostet zwei', en: 'Headwind: every foot of movement costs two' } },
  { id: 'sturm-blitz', schwere: 'mittel', spur: 'schaden', richtung: 'schaden', punkte: 7, themen: ['sturm'],
    text: { de: '1W8 Blitzschaden je Frist, solange du Metall trägst', en: '1d8 lightning damage each interval while you carry metal' } },
  { id: 'sturm-umgeworfen', schwere: 'schwer', spur: 'bewegung', richtung: 'debuff', punkte: 13, themen: ['sturm'],
  ...
  { id: 'sturm-regen-und-donner', schwere: 'schwer', spur: 'sinne', richtung: 'debuff', punkte: 14, themen: ['sturm'],
    text: { de: 'Regen und Donner nehmen dir alles: Du siehst nur 15 Fuß weit und hörst nichts', en: 'Rain and thunder take everything: you see only 15 feet and hear nothing' } },

  /* ---------- Stein ---------- */
  { id: 'stein-staub', schwere: 'leicht', spur: 'koerper', richtung: 'debuff', punkte: 3, themen: ['stein'],
  ...
  { id: 'stein-schwere-beine', schwere: 'mittel', spur: 'bewegung', richtung: 'debuff', punkte: 7, themen: ['stein', 'tiefe'],
  ...
  { id: 'stein-bis-zur-huefte', schwere: 'schwer', spur: 'bewegung', richtung: 'debuff', punkte: 15, themen: ['stein'],
  ...
  { id: 'stein-schwer-wie-fels', schwere: 'schwer', spur: 'bewegung', richtung: 'debuff', punkte: 12, themen: ['stein'],
    text: { de: 'Schwer wie Fels: Du kannst nicht klettern, springen oder schwimmen', en: 'Heavy as rock: you cannot climb, jump or swim' } },
  { id: 'stein-ganz', schwere: 'toedlich', spur: 'handlung', richtung: 'debuff', punkte: 30, themen: ['stein'],
  ...
  /* ---------- Blut ---------- */
  { id: 'blut-blutet', schwere: 'leicht', spur: 'schaden', richtung: 'schaden', punkte: 3, themen: ['blut'],
  ...
  { id: 'blut-geruch', schwere: 'leicht', spur: 'verteidigung', richtung: 'debuff', punkte: 2, themen: ['blut'],
  ...
  { id: 'blut-verlust', schwere: 'mittel', spur: 'koerper', richtung: 'debuff', punkte: 9, themen: ['blut'],
  ...
  { id: 'blut-durst', schwere: 'schwer', spur: 'geist', richtung: 'debuff', punkte: 14, themen: ['blut'],
  ...
  { id: 'blut-offene-wunde', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 13, themen: ['blut'],
    text: { de: 'Die Wunde geht nicht zu: Heilung wirkt bei dir nicht, bis sie genäht wird', en: 'The wound will not close: healing does not work on you until it is stitched' } },

  /* ---------- Schatten ---------- */
  { id: 'schatten-finster', schwere: 'leicht', spur: 'sinne', richtung: 'debuff', punkte: 3, themen: ['schatten'],
  ...
  { id: 'schatten-licht-erlischt', schwere: 'mittel', spur: 'sinne', richtung: 'debuff', punkte: 6, themen: ['schatten'],
    text: { de: 'Fackeln in deiner Hand geben kein Licht', en: 'Torches in your hand shed no light' } },
  { id: 'schatten-zehrt', schwere: 'schwer', spur: 'schaden', richtung: 'schaden', punkte: 14, themen: ['schatten'],
  ...
  { id: 'schatten-lichtscheu', schwere: 'schwer', spur: 'sinne', richtung: 'debuff', punkte: 12, themen: ['schatten'],
  ...
  { id: 'schatten-ohne-schatten', schwere: 'schwer', spur: 'geist', richtung: 'debuff', punkte: 13, themen: ['schatten'],
    text: { de: 'Dein Schatten ist fort: Nachteil auf Rettungswürfe gegen Furcht und Bezauberung', en: 'Your shadow is gone: disadvantage on saves against fear and charm' } },

  /* ---------- Zeit ---------- */
  { id: 'zeit-zu-spaet', schwere: 'leicht', spur: 'handlung', richtung: 'debuff', punkte: 3, themen: ['zeit'],
    text: { de: 'Einen Wimpernschlag zu spät: −5 auf Initiative', en: 'A blink too late: −5 to initiative' } },
  { id: 'zeit-zuletzt', schwere: 'mittel', spur: 'handlung', richtung: 'debuff', punkte: 9, themen: ['zeit'],
  ...
  { id: 'zeit-gealtert', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 12, themen: ['zeit'],
  ...
  { id: 'zeit-verlorene-runde', schwere: 'schwer', spur: 'handlung', richtung: 'debuff', punkte: 15, themen: ['zeit'],
  ...
  { id: 'zeit-aus-der-zeit', schwere: 'toedlich', spur: 'handlung', richtung: 'debuff', punkte: 27, themen: ['zeit'],
    text: { de: 'Du fällst aus der Zeit: handlungsunfähig, bis die nächste Frist endet', en: 'You fall out of time: incapacitated until the next interval ends' } },

  /* ---------- Klang ---------- */
  { id: 'klang-ton-im-ohr', schwere: 'leicht', spur: 'sinne', richtung: 'debuff', punkte: 3, themen: ['klang'],
  ...
  { id: 'klang-frisst-worte', schwere: 'mittel', spur: 'geist', richtung: 'debuff', punkte: 9, themen: ['klang'],
  ...
  { id: 'klang-schallschaden', schwere: 'schwer', spur: 'schaden', richtung: 'schaden', punkte: 14, themen: ['klang'],
    text: { de: '2W8 Schallschaden je Frist; Stille beendet den Zustand', en: '2d8 thunder damage each interval; silence ends it' } },
  { id: 'klang-betaeubt', schwere: 'schwer', spur: 'sinne', richtung: 'debuff', punkte: 13, themen: ['klang'],
  ...
  { id: 'klang-zerrissene-gedanken', schwere: 'schwer', spur: 'geist', richtung: 'debuff', punkte: 12, themen: ['klang'],
    text: { de: 'Der Ton zerreißt die Gedanken: Du verlierst deine Reaktion und hältst keine Konzentration', en: 'The tone tears your thoughts: you lose your reaction and cannot hold concentration' } },

  /* ---------- Traum ---------- */
  { id: 'traum-schlechter-schlaf', schwere: 'leicht', spur: 'koerper', richtung: 'debuff', punkte: 4, themen: ['traum'],
  ...
  { id: 'traum-wach-oder-nicht', schwere: 'mittel', spur: 'sinne', richtung: 'debuff', punkte: 6, themen: ['traum'],
  ...
  { id: 'traum-einschlafen', schwere: 'schwer', spur: 'handlung', richtung: 'debuff', punkte: 15, themen: ['traum'],
  ...
  { id: 'traum-schlafwandeln', schwere: 'schwer', spur: 'handlung', richtung: 'debuff', punkte: 13, themen: ['traum'],
    text: { de: 'Du schlafwandelst: Zu Beginn deines Zuges bestimmt die Spielleitung, wohin du gehst', en: 'You sleepwalk: at the start of your turn the GM decides where you go' } },

  /* ---------- Tiefe ---------- */
  { id: 'tiefe-druck', schwere: 'leicht', spur: 'koerper', richtung: 'debuff', punkte: 3, themen: ['tiefe'],
  ...
  { id: 'tiefe-keine-luft', schwere: 'mittel', spur: 'schaden', richtung: 'schaden', punkte: 7, themen: ['tiefe'],
    text: { de: '1W6 Schaden je Frist, bis du wieder Luft bekommst', en: '1d6 damage each interval until you can breathe again' } },
  { id: 'tiefe-truebe-sicht', schwere: 'mittel', spur: 'sinne', richtung: 'debuff', punkte: 6, themen: ['tiefe'],
    text: { de: 'Trübes Wasser vor den Augen: Du siehst nur 10 Fuß weit', en: 'Murky water before your eyes: you see only 10 feet' } },
  { id: 'tiefe-zieht-nach-unten', schwere: 'schwer', spur: 'bewegung', richtung: 'debuff', punkte: 14, themen: ['tiefe'],
  ...
  { id: 'tiefe-bis-in-die-knochen', schwere: 'schwer', spur: 'koerper', richtung: 'debuff', punkte: 12, themen: ['tiefe'],
    text: { de: 'Taubheit bis in die Knochen: Nachteil auf alle Stärke- und Geschicklichkeitsproben', en: 'Numb to the bone: disadvantage on all Strength and Dexterity checks' } }
];
